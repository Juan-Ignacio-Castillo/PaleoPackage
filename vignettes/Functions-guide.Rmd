...
The `volumetric()` function allows you to estimate the body mass of an organism based on its femur measurements. Here is a quick example:
...
# Estimate body mass
mass <- volumetric(reference_weight, reference_femur, estimated_femur)
print(mass)
```
